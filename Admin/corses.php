...
<nav class="nav-1 bg-red-950 navbar navbar-expand-lg fixed z-10">
   ...
   <!-- Suggestions will be displayed in below div. -->
                    ...
                    <a class="btn btn-warning mt-2" href="Edit-courses.php?Course_id=<?php echo $row[0];?>">Edit</a>
                        <a class="btn btn-danger mt-2" href="delete-teachers-action.php?Course_id=<?php echo $row[0];?>">Delete</a>
                    </td>
                <?php  echo "</tr>";
            }
        ?>
...
<script src="./search-course.js"></script>
</body>
</html>