...
<body>
    ...
    <div class="d-flex justify-content-lg-between justify-content-center">
            ...
            <nav class="bg-gray-950 h-screen d-none d-lg-block fixed">
              ...
              <h1 class="d-flex justify-content-center text-xl text-white">control panal</h1> -->
                ...
                <ul class="nav flex-column d-flex h-screen" style="margin-top: 90px;">
                    <li>
                        <a class="nav-link btn-nav fa-solid fa-graduation-cap d-flex align-items-center text-white active" aria-current="page" href="users.php"><span class="ms-1 font-normal font-sans text-base">Students</span></a>
                    </li>
                    <li>
                        <a class="nav-link btn-nav fa-solid fa-chalkboard-user d-flex align-items-center text-white" aria-current="page" href="teachers.php"><span class="ms-1 font-normal font-sans text-base">Teachers</span></a>
                    </li>
                    <li>
        ...
        <nav class="navbar bg-body-tertiary fixed-top d-lg-none d-block" >
    <div class="container-fluid">
    <button class="navbar-toggler mb-5 mt-5" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
    ...
    <div class="container data-table dash">
                <h1 class="text-3xl">Students</h1>
                <input class="mt-3 search-input" type="text" id="search" placeholder="Search" />
   <br>
   <div id="display"></div>
       ...
       <a class="btn btn-warning mt-2" href="Edit.php?Stu_id=<?php echo $row[0];?>"> Edit</a>
           <a class="btn btn-danger mt-2"  href="delete-action.php?Stu_id=<?php echo $row[0];?>"> Delete</a>
       </td>
    <?php  echo "</tr>";
    }
    ?>
