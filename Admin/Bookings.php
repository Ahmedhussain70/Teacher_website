...
<nav class="nav-1 bg-red-950 navbar navbar-expand-lg fixed z-10">
            ...
            <nav class="bg-gray-950 h-screen d-none d-lg-block fixed">
              ...
              <h1 class="d-flex justify-content-center text-xl text-white">control panal</h1> -->
                ...
                <ul class="nav flex-column d-flex h-screen" style="margin-top: 90px;">
                    ...
                    <li>
                        <a class="btn-nav fa-solid fa-file-circle-plus nav-link d-flex align-items-center text-white active" aria-current="page" href="Bookings.php"><span class="ms-1 font-normal font-sans text-base">Bookings</span></a>
                    </li>
                    <!-- <li>
    ...
    <div class="container data-table mt-5">
                <h1 class="text-3xl">Bookings</h1>
                <input class="mt-2" type="text" id="search" placeholder="Search" />
   <br>
   <div id="display"></div>
       <table class="table table-hover my-10">
           ...
           <th class="bg-light"> Hospital name</th>
           <th class="bg-light"> Department name</th>
           <th class="bg-light"> Diagnosis</th>
       ...
       <!-- hena el row[0] ma3naha awl column fel db el hoa el id fana bab3to ma3 el click 3ashen a3raf amyz  -->
           <a class="btn btn-danger"  href="delete-booking-action.php?id_order=<?php echo $row[0];?>"><i class="fa-solid fa-xmark"></i> Cancel</a>
       </td>
    <?php  echo "</tr>";
    }
    ?>
